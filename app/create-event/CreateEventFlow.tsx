...
type Plan = { source: string; location: string; resolvedLocation: LocationCandidate; score: number; bestWindow: string; space: string; activity: string; advice: Array<{ tone: string; title: string; copy: string }> };
