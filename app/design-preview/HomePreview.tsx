...
type Snapshot = { label?:string; current?:{temp_f:number;feels_like_f?:number;wind_mph:number|null;humidity_pct?:number|null;weather_code:number}|null; days?:WeatherDay[]; air_quality?:{us_aqi:number;category:string;updated_at:string}|null };
